...
\SMR\ (sub-millimetre radiometer) \citep{murtagh:anove:02}. 
...
In this section an overview of \smr\ Level2 data products and requirements are given, and
...
The overall aim of the new Level2 data processing also reflect
...
A requirement is therefore that an inventory/review of the Level1B 
algorithm and data, and all other input data, 
applied in the Level2 processing must be performed
(see Chapter\ref{level2-algorithms}). 
A further requirement is also that the new Level2 dataset
must be validated by comparison to correlative datasets, 
...
Level2 processing of the science data products are in principle
identical to that from the main data products, although
