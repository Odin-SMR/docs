...
%This document focuses on the processing of the sub-millimetre data, but
%comments on the adaptions required to also handle the 118\,GHz data are given.
...
Profiles of \chem{H_{2}O}, \chem{CO}, \chem{NO} and isotopologues of \chem{H_{2}O}, and \chem{O_{3}}
...
\begin{tabular}{|l|l|l|l|l|l|l|}
  \hline
  \textbf{Product}  & \textbf{Frequency}      & \textbf{Frequency} & \textbf{Vertical}          & \textbf{Vertical}            & \textbf{Precision} & \textbf{Reference} \\
                    & \textbf{mode}           & \textbf{{[}GHz{]}} & \textbf{coverage}          & \textbf{resolution}          &                    &                 \\
  \hline
  \chem{O_{3}}      & 1                       & 501.5              & \(\sim\)19--50\,km         &  \(\sim\)2\,km               & 0.5--2\,ppmv       &  \citep{urban:odins:05-b} \\
  \hline
  \chem{ClO}        & 1                       & 501.3              & \(\sim\)19--67\,km         &  1.5--2\,km                  & 0.15--0.2\,ppbv    & \citep{urban:odins:05-b} \\
  \hline
  \chem{N_{2}O}     & 1			      & 502.3              & \(\sim\)15--70\,km         &  \(\sim\)1.5\,km             & 15--35\,ppbv       & \citep{urban:odins:05-b} \\
  \hline
  \chem{O_{3}}      & 2                       & 544.9              & \(\sim\)18--70\,km         &  \(\sim\)1.5\,km             & 0.2--0.4\,ppmv     & \citep{urban:odins:05-b} \\
  \hline
  \chem{HNO_{3}}    & 2                       & 544.4              & \(\sim\)21--67\,km         &  1.5--2\,km                  & 1 ppbv             & \citep{urban:odins:05-b} \\
  \hline
\end{tabular}}
\end{table}

\begin{table}
\caption{ Characteristics of \smr\ Level2 science data products.}%\lcomment{BR}{Add accuracy column}}
\label{table:level2b}
\scalebox{0.9}{%
\begin{tabular}{|l|l|l|l|l|l|l|l|}
  ...
  \textbf{Product}      & \textbf{Frequency} & \textbf{Frequency} & \textbf{Vertical}          & \textbf{Vertical}            & \textbf{Precision} & \textbf{Reference} \\
                        & \textbf{mode}      & \textbf{{[}GHz{]}} & \textbf{coverage}          & \textbf{resolution}          &                    &                 \\
  \hline
  \chem{CO}             &  14                & 578.6              & \(\sim\)17--110\,km        &  3--4\,km                    & 25\,ppbv--2\,ppmv  & \citep{dupuy:strat:04} \\
  \hline
  \chem{H_{2}\,^{16}O}  &  13,19             & 556.9              & \(\sim\)40--100\,km        &  \(\sim\)3\,km               & 0.5--1\,ppmv       & \citep{urban:globa:07} \\
  \hline
  \chem{H_{2}\,^{16}O}  &  8                 & 488.5              & \(\sim\)20--70\,km         &  \(\sim\)3\,km               & 0.5--1\,ppmv       & \citep{urban:globa:07} \\
  \hline
  \chem{HDO}            &  17	             & 490.6              & \(\sim\)20--70\,km         &  3--4\,km                    & 0.5\,ppbv          & \citep{urban:globa:07} \\
  \hline
  \chem{H_{2}\,^{18}O}  &  8                 & 489.1              & \(\sim\)20--65\,km         &  3--4\,km                    & 20-30\,ppbv        & \citep{urban:globa:07} \\
  \hline
  \chem{H_{2}\,^{17}O}  &   21               & 552.0              & \(\sim\)20--70\,km         & \(\sim\)3\,km                & 0.4\,ppbv          & \citep{urban:globa:07} \\
  \hline
  \chem{NO}             &   21               & 551.7              & \(\sim\)40--100\,km        & \(\sim\)7\,km               & 40\,\(\%\)          & \citep{sheese:odino:2013} \\
  \hline
  \chem{^{16}O\,^{18}O\,^{16}O} & 17         & 490.4     & \(\sim\)27--41\,km         & 4--6\,km                     & 25\,\(\%\)         & \citep{urban:globa:13} \\
  \hline
  \chem{^{16}O\,^{16}O\,^{18}O} & 17         & 490.0     & \(\sim\)25--45\,km         & 3--4\,km                     & 25\,\(\%\)         & \citep{urban:globa:13} \\
  \hline
  \chem{^{16}O\,^{16}O\,^{17}O} &  17        & 490.6     & \(\sim\)31--39\,km         & 5--6\,km                     & 25\,\(\%\)         & \citep{urban:globa:13}  \\
  \hline
\end{tabular}}
\end{table}
