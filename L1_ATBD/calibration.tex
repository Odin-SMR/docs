...
\item calibration target temperature uncertainty: 0.2 K ?

\item baffle temperature uncertainty: 0.3 K ?

\item standing waves: 1 K ?
...
Within, the calibration algorithm, the noise of each sub-band a of
considered spectrum is calculated as the root mean square diffence between
the actual brightness temperature and average brightness temperature of the band, i.e.
\begin{equation}
\Delta T^{2} = E( (Tb-E(Tb))^{2} ).
\end{equation}
