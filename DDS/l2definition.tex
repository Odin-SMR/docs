...
\citep{murtagh:anove:02}.  Originally, Odin was used for both atmospheric and
...
The \smr\ package is highly flexible \citep{frisk:theod:03}.  In short, the
...
\begin{table}
\caption{Characteristics of \smr\ Level2 maim data products  for version~2 of
...
\begin{tabular}{lrrrrr}
  ...
  \midrule
  \chem{O_{3}}          & 501.5 (FM 01)             & \(\sim\)19--50\,km         &  \(\sim\)2\,km               & 0.5--2\,ppmv       &  \citep{urban:odins:05-b} \\
  \chem{ClO}            & 501.3   (FM 01)           & \(\sim\)19--67\,km         &  1.5--2\,km                  & 0.15--0.2\,ppbv    & \citep{urban:odins:05-b} \\
  \chem{N_{2}O}         & 502.3   (FM 01)           & \(\sim\)15--70\,km         &  \(\sim\)1.5\,km             & 15--35\,ppbv       & \citep{urban:odins:05-b} \\
  \midrule
  \chem{O_{3}}          & 544.9  (FM 02)            & \(\sim\)18--70\,km         &  \(\sim\)1.5\,km             & 0.2--0.4\,ppmv     & \citep{urban:odins:05-b} \\
  \chem{HNO_{3}}        & 544.4  (FM 02)            & \(\sim\)21--67\,km         &  1.5--2\,km                  & 1 ppbv             & \citep{urban:odins:05-b} \\
  \bottomrule
\end{tabular}}
\end{table}
...
\begin{tabular}{lrrrrr}
  ...
  \textbf{Product}      & \textbf{Frequency} & \textbf{Vertical}          & \textbf{Vertical}            & \textbf{Precision} & \textbf{Reference} \\
                        & \textbf{{[}GHz{]}} & \textbf{coverage}          & \textbf{resolution}          &                    &                 \\
  \midrule
  \chem{CO}             & 578.6  (FM 22)            & \(\sim\)17--110\,km        &  3--4\,km                    & 25\,ppbv--2\,ppmv  & \citep{dupuy:strat:04} \\
  \chem{H_{2}\,^{16}O}  & 556.9   (FM 19)           & \(\sim\)40--100\,km        &  \(\sim\)3\,km               & 0.5--1\,ppmv       & \citep{urban:globa:07} \\
  \midrule
  \chem{H_{2}\,^{16}O}  & 488.5  (FM 17)            & \(\sim\)20--70\,km         &  \(\sim\)3\,km               & 0.5--1\,ppmv       & \citep{urban:globa:07} \\
  \chem{HDO}            & 490.6   (FM  17)          & \(\sim\)20--70\,km         &  3--4\,km                    & 0.5\,ppbv          & \citep{urban:globa:07} \\
  \chem{H_{2}\,^{18}O}  & 489.1   (FM 08)           & \(\sim\)20--65\,km         &  3--4\,km                    & 20-30\,ppbv        & \citep{urban:globa:07} \\
  \midrule
  \chem{H_{2}\,^{17}O}  & 552.0  (FM 21)            & \(\sim\)20--70\,km         & \(\sim\)3\,km                & 0.4\,ppbv          & \citep{urban:globa:07} \\
  \chem{NO}             & 551.7    (FM 21)          & \(\sim\)40--100\,km        & \(\sim\)7\,km               & 40\,\(\%\)          & \citep{sheese:odino:2013} \\
  \midrule
  \chem{^{16}O\,^{18}O\,^{16}O}  & 490.4 (FM 17)     & \(\sim\)27--41\,km         & 4--6\,km                     & 25\,\(\%\)         & \citep{urban:globa:13} \\
  \chem{^{16}O\,^{16}O\,^{18}O}  & 490.0  (FM 17)   & \(\sim\)25--45\,km         & 3--4\,km                     & 25\,\(\%\)         & \citep{urban:globa:13} \\
  \chem{^{16}O\,^{16}O\,^{17}O}  & 490.6  (FM 17)   & \(\sim\)31--39\,km         & 5--6\,km                     & 25\,\(\%\)         & \citep{urban:globa:13}  \\
  \bottomrule
\end{tabular}}
\end{table}
