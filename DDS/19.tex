...
FM19 is an alternative mode for measuring water vapour in the mesosphere. As with FM13 we suspect some non-linearity problems that we have not yet managed to track down.  Indications of this are the underestimation of temperature and water vapour itself 
...
instruments.
Figure~\ref{fig:fm19:O3:mr_avk} suggests that the product is useful over the range 44-80 km with a vertical resolution of around 6 km. 
...
a systematic under estimation of the concentrations has been introduced. comparisons with MLS suggest a -20 % bias as with FM13 but with a increasing bias with altitude.  The MIPAS product used seems to be unreliable at thes altitudes 
...
Figure~\ref{fig:fm19:H2O:mr_avk} suggests that the product is useful over the range 44-110 km with a vertical resolution of around 4 km. 
...
Figure~\ref{fig:fm19:T:mr_avk} suggests that the product is useful over the range 44-95 km with a vertical resolution of around 5 km. 
