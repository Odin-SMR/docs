...
chain. The results show a better over-all consistency with the updated version
...
individual retrievals for the instruments for the entire period are plotted
against the retrievals from the new and old versions of the \smr\ processing
chain. The results show a slightly improved over-all consistency with the
...
the correlation with MIPAS remains poor.
