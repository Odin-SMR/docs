...
maximum} of the averaging kernels and the \emph{total error} as defined
in~\cite{atbdl2} respectively.
...
possible. This will require some effort and will probably not be possible
