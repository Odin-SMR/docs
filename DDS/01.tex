...
Frequency mode 1 monitors two bands, $501.180$--$501.580\,\mathrm{GHz}$ and
...
shown in Figure~\ref{fig:fm1:O3:profiles}. In Figure~\ref{fig:fm1:O3:scatter}
...
\begin{figure}[htpb]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \caption{average difference to MIPAS}
        \label{fig:fm1:N2O:profiles:MIPAS}
    \end{subfigure}
    \,
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{DDS_fm1_N2O_perdiff_mls}
        \caption{average difference to MLS}
        \label{fig:fm1:N2O:profiles:MLS}
    \end{subfigure}
    ...
    $\leq 0.03\,\mathrm{ppm}$ have been filtered out.)}
    \label{fig:fm1:N2O:profiles}
\end{figure}
...
Figure~\ref{fig:fm1:N2O:profiles}. In Figure~\ref{fig:fm1:N2O:scatter}
individual retrievals for the instruments for the entire period are plotted
agains the retrievals from the new and old versions of the \smr\ processing
...
\begin{figure}[htpb]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \caption{average difference to MLS}
        \label{fig:fm1:ClO:profiles:MLS}
    \end{subfigure}
    \caption{Average difference in percent between retrievals of \chem{N_2O}
    from \smr~v3 and collocated measurements from various instruments at
    different altitudes. (Retrievals yielding concentrations
    $\leq 0.3\,\mathrm{ppb}$ have been filtered out.)}
    \label{fig:fm1:ClO:profiles}
\end{figure}
...
\begin{figure}[htpb]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \label{fig:fm1:ClO:scatter:v2}
    \end{subfigure}
    \,
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{DDS_fm1_ClO_scatter_v3}
        \caption{correlation of collcated MLS measurements with \smr~v3}
        \label{fig:fm1:ClO:scatter:v3}
    \end{subfigure}
    \caption{Correlation between retrievals of \chem{N_2O} using \smr\
    versions~2.X and~3 and collocated measurements MLS.}
    \label{fig:fm1:ClO:scatter}
\end{figure}
...
Figure~\ref{fig:fm1:ClO:profiles}. In Figure~\ref{fig:fm1:ClO:scatter}
...
Figure~\ref{fig:fm1:ClO:scatter} suggests that this is due to poor quality of
...
The results are summarised in Table~\ref{tab:fm1:stats}, and show that the
...
retrievals for frequency mode 1, compared with collocated data from other
...
Based on the discussion above, retrievals based on frequency mode~1 can be used
with confidence for the species~\chem{O_3} and~\chem{N_2O} for the investigated
period. Retrievals of \chem{ClO} based on this frequency mode should be used
with some caution.
