...
collocated measurements from various instruments as accumulated in the Validation Data Set (VDS)\cite{vds} .
The VDS cover the period 2003-2015.  This implies that the DDS also is restricted to the same period.
The comparisons are organised
...
This has been carried out for the main data products ie those from FM1, FM2, FM8, FM13 and FM19.
The other science mode products require separate treatment since they must be compared to special 
products from the other instruments. This cannot be done in the context of this report..
