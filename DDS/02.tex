...
agreement with SAGE since it is a occultation instrument it measures closest to
Odin's local time.  Figure~\ref{fig:fm02:O3:mr_avk} suggests that the product
is useful over the range 17--77~km with a vertical resolution of around 3.5~km.
