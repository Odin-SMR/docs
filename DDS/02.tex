...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.95\textwidth]{spectra/fm_02_spectra_winter}
...
Figure~\ref{fig:fm02:HNO3:mr_avk} suggests that the product is useful over the range 20-60 km with a vertical resolution of around 6 km.
...
high altitudes.
Figure~\ref{fig:fm02:T:mr_avk} suggests that the product is useful over the range 20-60 km with a vertical resolution of around 7.5 km.
