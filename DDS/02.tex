...
used with confidence for the species \chem{O_3} and 
for temperature. For \chem{HNO_3}, some caution is warrented.  We hope to solve this problem before the entire data set is processed.
