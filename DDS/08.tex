...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.95\textwidth]{spectra/fm_08_spectra_winter_97u}
...
some sort of underestimation of the intensity.  Spectroscopic data are taken from the HITRAN 12 
database updated with the latest laboratory results see (\cite{atbdl2}).  
