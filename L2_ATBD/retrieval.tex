...
a priori value of $\Delta\VctStl{o}$, $\Delta\theta$
and $\Delta\nu$ is throughout set to zero.
...
\begin{equation}
  ...
  \begin{bmatrix}
    ...
    0 & 0 & 0 & \aCvrMtr{\VctStl{\Delta\VctStl{o}}} & 0 & 0 \\
    0 & 0 & 0 & 0 & \aCvrMtr{\Delta\theta} & 0 \\
    0 & 0 & 0 & 0 & 0 & \aCvrMtr{\Delta\nu} \\
  \end{bmatrix}.
\end{equation}
