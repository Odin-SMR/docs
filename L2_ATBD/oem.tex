...
different observation modes. Actual values are listed in ???\todo{This
...
observation modes, see ???\todo{This document does not yet exist}.
...
found in ???\todo{This document does not yet exist}.
