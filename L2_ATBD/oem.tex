...
variance and exponentially declining correlation\todo{This option used? Revise
  paragraph later.}\ \citep[][Sec.~10.3.2.2]{rodgers:00}.
...
corresponding variance in \aCvrMtr{a}.\todo{Add equations for this.}
