...
which of the two potential problems that is the cause behind a suspiciously high end
value of $\CstFnc'$.  
\\
...
However, a direct calculation of the inverse of \aCvrMtr{a} and \aCvrMtr{o} cannot be avoided. These calculations take advantage of the block-diagonal
structure (see Sec.~?) \todo{Which section?}, where each sub-matrix is inverted separately. Further,
in some situations the matrix inverse can be obtained in an analytic manner.
