...
?\,m\todo{Add value.}\ in tangent altitude, and observed frequencies can be
controlled with an accuracy better than ?\,MHz\todo{Add value.}. The retrieval
...
Some other non-nominal features are handled, or are characterised, fairly
...
about 2\,K and is uncorrelated between tangent altitudes, and front-ends \todo{I find the placement of the comma odd. Do you mean "uncorrelated between tangent altitudes and front-ends" or "uncorrelated between tangent altitudes, and between frontends"?}. The
