...
can be controlled with an accuracy of $\approx1$\,MHz\todo{Later revise the
  number in this paragrapph.}. The retrieval process includes both a pointing
...
temperature, and is presently estimated to \dots\todo{Add result later.}\ \smr\
...
2\,K, and iare uncorrelated between tangent altitudes and front-ends. The
