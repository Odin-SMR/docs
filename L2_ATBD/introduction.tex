...
ripples are largely removed as part of the L1b processing\addref. The
...
be seen as a flat baseline ripple). These shifts have a standard deviation of
about 2\,K, and iare uncorrelated between tangent altitudes and front-ends. The
