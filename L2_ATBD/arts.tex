...
see Sec.~?. The lower limit of the atmosphere is determined by the planet's
surface, and \ARTS\ demands that a surface is always defined. The altitude of
the surface is for these simulations set to ?\,km\todo{Add number}, and
regarding radiative properties it is set to behave as a blackbody.
...
hand.\todo{Will the FillGrid method be used?}\ The variables controlling
