...
(see AUG). The maximum step length of the ray tracing is set to ?\,km\todo{Add
  value}, which is estimated to give a tangent point accuracy better than
?\,m\todo{Add value}\ for tangent altitudes above 15\,km\todo{Perform test}.
