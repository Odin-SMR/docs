...
that \aCvrMtr{a}\ is partly used as a ``tuning parameter''. The most common
example is that the variances in \aCvrMtr{a}\ are set with some margin to the
...
Further, it is likely that \aSttVct{a}\ differs from the true mean mean value
