...
model \ARTS\ (\ARTSlong) is used for \smr\
...
based on the latest version. \todo{which, at the time of writing, is \ldots?}
At this point it is just noted that \ARTS\ complies
