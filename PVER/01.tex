...
\begin{figure}[tbhp]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{{ALL-Strat-v3.0.0_fm1_O3_perdiff_mipas}.pdf}
        \caption{average difference to MIPAS}
        \label{fig:fm01:O3:profiles:MIPAS}
    \end{subfigure}
    \,
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{{ALL-Strat-v3.0.0_fm1_O3_perdiff_mls}.pdf}
        \caption{average difference to MLS}
        \label{fig:fm01:O3:profiles:MLS}
    \end{subfigure}

    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{{ALL-Strat-v3.0.0_fm1_O3_perdiff_osiris}.pdf}
        \caption{average difference to OSIRIS}
        \label{fig:fm01:O3:profiles:OSIRIS}
    \end{subfigure}
    \,
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{{ALL-Strat-v3.0.0_fm1_O3_perdiff_sage}.pdf}
...
\begin{figure}[tbhp]
    \centering
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{{ALL-Strat-v3.0.0_fm1_O3_scatter_v2}.pdf}
        \caption{correlation of collcated instruments with \smr~v2.X}
        \label{fig:fm01:O3:scatter:v2}
    \end{subfigure}
    \,
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{{ALL-Strat-v3.0.0_fm1_O3_scatter_v3}.pdf}
...
\begin{figure}[tbhp]
    \centering
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{{ALL-Strat-v3.0.0_fm1_O3_mr}.pdf}
    ...
    \,
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{{ALL-Strat-v3.0.0_fm1_O3_avk}.pdf}
...
\begin{figure}[tbhp]
    \centering
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{{ALL-Strat-v3.0.0_fm1_N2O_perdiff_mipas}.pdf}
        \caption{average difference to MIPAS}
        \label{fig:fm01:N2O:profiles:MIPAS}
    \end{subfigure}
    \,
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{{ALL-Strat-v3.0.0_fm1_N2O_perdiff_mls}.pdf}
        \caption{average difference to MLS}
...
\begin{figure}[tbhp]
    \centering
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{{ALL-Strat-v3.0.0_fm1_N2O_scatter_v2}.pdf}
        \caption{correlation of collcated instruments with \smr~v2.X}
        \label{fig:fm01:N2O:scatter:v2}
    \end{subfigure}
    \,
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{{ALL-Strat-v3.0.0_fm1_N2O_scatter_v3}.pdf}
        \caption{correlation of collcated instruments with \smr~v3}
...
\begin{figure}[tbhp]
    \centering
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{{ALL-Strat-v3.0.0_fm1_N2O_mr}.pdf}
        \caption{median measurement response with $1\sigma$ and $2\sigma$
        percentiles}
    ...
    \,
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{{ALL-Strat-v3.0.0_fm1_N2O_avk}.pdf}
        \caption{median averaging kernels\newline~}
...
\begin{figure}[tbhp]
    \centering
    \includegraphics[width=0.666\textwidth]{{ALL-Strat-v3.0.0_fm1_ClO_perdiff_mls}.pdf}
...
\begin{figure}[tbhp]
    \centering
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{{ALL-Strat-v3.0.0_fm1_ClO_scatter_v2}.pdf}
        \caption{correlation of collcated MLS measurements with \smr~v2.X}
        \label{fig:fm01:ClO:scatter:v2}
    \end{subfigure}
    \,
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{{ALL-Strat-v3.0.0_fm1_ClO_scatter_v3}.pdf}
...
\begin{figure}[tbhp]
    \centering
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{{ALL-Strat-v3.0.0_fm1_ClO_mr}.pdf}
    ...
    \,
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{{ALL-Strat-v3.0.0_fm1_ClO_avk}.pdf}
        \caption{median averaging kernels\newline~}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.666\textwidth]{DDS_fm1_O3_corr.pdf}
