...
\begin{table}[tbhp]
    \centering
    \caption{Characteristics of \smr\ Level2 main  Version 3.0 data products.}
...
\begin{enumerate}
\item The unfortunate degradation in the FM~01 performance over a long period is well worth an attempt to correct the data and retrieve the \chem{ClO} measurements between 2009 and 2018.  
